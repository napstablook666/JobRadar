...
public final class Job51Locators {
    ...
    public static final String[] APPLY_TEXTS = {
            "立即投递",
            "立即申请",
            "投递"
    };

    public static final String[] APPLY_CONFIRM_TEXTS = {
            "立即申请",
            "确认投递",
            "确认申请",
            "确定",
    ...
    public static final String[] MESSAGE_INPUT_SELECTORS = {
            ...
            "textarea[placeholder*='内容']:visible",
            "textarea[class*='message']:visible",
            "textarea[class*='chat']:visible",
            "textarea:visible",
            "[contenteditable='true'][data-placeholder*='消息']:visible",
            "[contenteditable='true'][data-placeholder*='沟通']:visible",
            "[contenteditable='true'][class*='message']:visible",
            "[contenteditable='true'][class*='chat']:visible",
            "[contenteditable='true']:visible",
            "input[placeholder*='消息']:visible",
            "input[placeholder*='沟通']:visible",
