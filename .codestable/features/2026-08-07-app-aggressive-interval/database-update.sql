...
SET min_delay_seconds = 90,
    max_delay_seconds = 180,
    search_min_delay_seconds = 30,
    search_max_delay_seconds = 60,
    page_min_delay_seconds = 15,
    page_max_delay_seconds = 30,
    detail_min_delay_seconds = 20,
    detail_max_delay_seconds = 40,
    rate_guard_batch_size = 5,
    batch_cooldown_min_seconds = 600,
    batch_cooldown_max_seconds = 900
WHERE id = 1;
